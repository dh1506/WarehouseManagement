...
export const createProductSchema = z.object({
  body: z.object({
    ...
    product_type: productTypeEnum.optional(),
    brand_id: z.number().int().positive('ID thương hiệu phải là số nguyên dương').optional(),
    manufacturer_id: z.number().int().positive('ID nhà sản xuất phải là số nguyên dương').optional(),
    ...
    min_stock: z.number().nonnegative('Tồn kho tối thiểu không được âm').optional(),
    max_stock: z.number().nonnegative('Tồn kho tối đa không được âm').optional(),
    storage_conditions: z.string().max(255, 'Điều kiện bảo quản tối đa 255 ký tự').optional(),
...
export const updateProductSchema = z.object({
  ...
  body: z.object({
    ...
    product_type: productTypeEnum.optional(),
    product_status: productStatusEnum.optional(),
    brand_id: z.number().int().positive('ID thương hiệu phải là số nguyên dương').optional().nullable(),
    manufacturer_id: z.number().int().positive('ID nhà sản xuất phải là số nguyên dương').optional().nullable(),
    base_uom_id: z.number().int().positive('ID đơn vị tính cơ sở phải là số nguyên dương').optional(),
    has_batch: z.boolean().optional(),
    has_expiry: z.boolean().optional(),
    min_stock: z.number().nonnegative('Tồn kho tối thiểu không được âm').optional().nullable(),
    max_stock: z.number().nonnegative('Tồn kho tối đa không được âm').optional().nullable(),
    storage_conditions: z.string().max(255, 'Điều kiện bảo quản tối đa 255 ký tự').optional().nullable(),
