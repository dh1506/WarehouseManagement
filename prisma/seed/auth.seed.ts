...
export async function seedAuth(prisma: PrismaClient) {
  ...
  const permissions = [
    ...
    {
      name: "location_allowed_categories:read",
      description: "Xem danh mục cho phép tại vị trí",
      module: "location_allowed_categories",
      action: "read",
    },
    {
      name: "location_allowed_categories:create",
      description: "Thêm danh mục cho phép tại vị trí",
      module: "location_allowed_categories",
      action: "create",
    },
    {
      name: "location_allowed_categories:update",
      description: "Cập nhật danh mục cho phép tại vị trí",
      module: "location_allowed_categories",
      action: "update",
    },
    {
      name: "location_allowed_categories:delete",
      description: "Xóa danh mục cho phép tại vị trí",
      module: "location_allowed_categories",
      action: "delete",
    },
    ...
    // STOCK OUTS
    {
      name: "stock_outs:read",
      description: "Xem phiếu xuất",
      module: "stock_outs",
      action: "read",
    },
    {
      name: "stock_outs:create",
      description: "Tạo phiếu xuất",
      module: "stock_outs",
      action: "create",
    },
    {
      name: "stock_outs:update",
      description: "Sửa phiếu xuất",
      module: "stock_outs",
      action: "update",
    },
    {
      name: "stock_outs:approve",
      description: "Duyệt phiếu xuất",
      module: "stock_outs",
      action: "approve",
    },
    {
      name: "stock_outs:cancel",
      description: "Hủy phiếu xuất",
      module: "stock_outs",
      action: "cancel",
    },
    ...
    },
    {
      ...
      description: "Tạo giao dịch điều chỉnh",
      module: "inventory_transactions",
      action: "create",
    },
  ];
  ...
  const users = [
    ...
    {
      username: "hung.manager",
      full_name: "Nguyễn Văn Hùng",
      email: "hung.mng@fb.com",
    ...
    },
    {
      ...
      email: "tuan.staff@fb.com",
      role_id: roleMap["STAFF"],
    },
    {
      username: "son.staff",
      full_name: "Vũ Hồng Sơn",
      email: "son.staff@fb.com",
      role_id: roleMap["STAFF"],
    },
  ];
